...
void controller::engine::keyboard(unsigned char key, int x, int y){
	switch (key){
		...
		case 'F':    camera1.slide(0,0,-5.0); break; // slide camera forward
		case 'F'-64: camera1.slide(0,0, 5.0); break; //slide camera back	
		case 'L':    camera1.slide(-5.0, 0, 0); break; // slide camera left
		case 'L'-64: camera1.slide(5.0, 0, 0); break; //slide camera right
		case 'U':    camera1.slide(0, 5.0, 0); break; // slide camera up
		case 'U'-64: camera1.slide(0, -5.0, 0); break; //slide camera down	
